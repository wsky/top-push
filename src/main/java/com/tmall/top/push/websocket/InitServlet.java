...
public class InitServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		PushManager.current(new PushManager(
				...
				this.get(config, "publishMessageSize"),
				this.get(config, "confirmMessageSize"),
				this.get(config, "publishMessageBufferCount"),
				this.get(config, "confirmMessageBufferCount"),
